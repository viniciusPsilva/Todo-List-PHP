    ...
    <body>          
        ...
        <div class="container">
            <div class="row" style="margin-top: 50px;">
                ...
                <form class="col s6" method="POST"action="<?= Controller::url('usuario/cadastrar')?>">
                 <?php if(isset($erro)){?> <span class="erro-Alert fadeIn"><?=$erro?> </span> <?php };?>  
                    ...
                    <div class="row">
                        ...
                        <button class="btn waves-effect waves-light amber lighten-1 right" type="submit" name="action">Enviar
                ...
                <div class="col s6">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <span class="card-title activator grey-text text-darken-4">Cadastre-se<i class="material-icons right">more_vert</i></span>
                        ...
                        <div class="card-reveal">
                            ...
                            <p>Cadastre-se para usar um gerenciador de tarefas efiente para seus afazeres diários</p>
                        </div>
                    </div>
